...
public class replace : MonoBehaviour {
	...
	void FixedUpdate() {
		...
		if (Input.GetMouseButtonUp (0) && global.GetComponent<globalValue> ().Button == 3 && Physics.Raycast (ray, out hit, 100, 1 << LayerMask.NameToLayer("PlacementGrid")) && old && timenb == 0) {
		...
		if (Physics.Raycast (ray, out hit, 100, 1 << LayerMask.NameToLayer("PlacementGrid")) && global.GetComponent<globalValue> ().Button == 3 && timenb == 0) {
